                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group{{ $errors->has('organisation_name') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="organisation_name" type="text" class="form-control" name="organisation_name" value="{{ old('organisation_name') }}" >
                        ...
                        <div class="form-group{{ $errors->has('address') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                ...
                                <!--<textarea name="address" cols="40" rows="6">{{old('address')}}</textarea>-->
